...
pub fn cli_config_home_directory() -> Result<PathBuf, GetCLICfgHomeDirectoryError> {
...
pub fn cli_config_file_path() -> Result<PathBuf, GetCLICfgFilePathError> {
    // Get the path to the config directory for the current platform
    let cli_config_dir = cli_config_home_directory()?;
